...
\textit{(confirmar contra el título literal guardado en osf.io/yp7t3)} \\
...
Plantilla, licencia y DOI &
\textit{[Pendiente: completar leyendo directamente el panel lateral de
osf.io/yp7t3. Los valores de la v1.0 (Preregistration, CC0 1.0, sin DOI)
describían el proyecto \texttt{wud69} y no deben arrastrarse sin confirmar contra
