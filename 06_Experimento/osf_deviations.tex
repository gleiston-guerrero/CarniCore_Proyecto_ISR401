...
originales se conservan sin alteración alguna. Esto se verificó de forma
mecánica comparando \texttt{rf25.json} contra \texttt{rf27.json} antes de que
\texttt{rf25.json} se eliminara como parte de la mitigación de DEV-03 (ver
\texttt{07\_Datos/desviaciones.md}): los 25 primeros elementos resultaron
idénticos campo a campo.
...
\textbf{Mitigación aplicada, 14/09/2026.} Se ejecutó
